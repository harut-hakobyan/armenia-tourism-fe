...
export function CustomTripPage() {
  ...
  function continueBooking() { if (!estimate.data) return; bookingDraft.set({ service_type: 'custom_trip', car_id: automaticCarId, route_points: estimate.data.route_points ?? points(), estimate: estimate.data, service_options: { return_to_yerevan: true } }); void navigate('/booking?service=custom_trip') }
