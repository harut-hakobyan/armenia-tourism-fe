...
export interface CarFilters extends Pick<CatalogFilters, 'page' | 'per_page'> { category?: Car['category']; type?: Car['type']; passengers?: number; luggage?: number; child_seat?: boolean; sort?: 'recommended' | 'price_asc' | 'capacity_desc' }
