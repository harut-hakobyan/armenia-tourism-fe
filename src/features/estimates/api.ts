...
export interface RouteEstimateInput extends BaseEstimateInput { route_points: RoutePoint[] }
export interface TransferEstimateInput extends RouteEstimateInput { extra_waiting_minutes?: number }
export interface PrivateDriverEstimateInput extends BaseEstimateInput { duration_minutes: number }
