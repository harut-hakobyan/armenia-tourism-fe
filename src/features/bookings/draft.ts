...
export interface BookingDraft { service_type: ServiceType; passengers?: number; car_id?: number; tour_id?: number; duration_minutes?: number; route_points?: RoutePoint[]; dropoff_address?: string; service_options?: Record<string, unknown>; estimate?: Estimate }
