...
export interface BookingDraft { service_type: ServiceType; passengers?: number; car_id?: number; tour_id?: number; promo_code?: string; duration_minutes?: number; route_points?: RoutePoint[]; dropoff_address?: string; service_options?: Record<string, unknown>; estimate?: Estimate }
