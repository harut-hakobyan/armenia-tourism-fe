...
const ToursPage = lazy(() =>
  import("@/pages/catalog/ToursPage").then((module) => ({
    default: module.ToursPage,
  })),
);
const TourDetailsPage = lazy(() =>
  import("@/pages/catalog/TourDetailsPage").then((module) => ({
    default: module.TourDetailsPage,
  })),
);
...
const DestinationsPage = lazy(() =>
  import("@/pages/catalog/DestinationsPage").then((module) => ({
    default: module.DestinationsPage,
  })),
);
const DestinationDetailsPage = lazy(() =>
  import("@/pages/catalog/DestinationDetailsPage").then((module) => ({
    default: module.DestinationDetailsPage,
  })),
);
const CarsPage = lazy(() =>
  import("@/pages/catalog/CarsPage").then((module) => ({
    default: module.CarsPage,
  })),
);
const CustomTripPage = lazy(() =>
  import("@/pages/services/CustomTripPage").then((module) => ({
    default: module.CustomTripPage,
  })),
);
...
const BookingStatusPage = lazy(() =>
  import("@/pages/booking/BookingStatusPage").then((module) => ({
    default: module.BookingStatusPage,
  })),
);
const contentPages = () => import("@/pages/content/ContentPages");
const AboutPage = lazy(() =>
  contentPages().then((module) => ({ default: module.AboutPage })),
);
const ContactPage = lazy(() =>
  contentPages().then((module) => ({ default: module.ContactPage })),
);
const FaqPage = lazy(() =>
  contentPages().then((module) => ({ default: module.FaqPage })),
);
