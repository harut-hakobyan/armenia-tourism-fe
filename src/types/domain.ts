...
export interface AssignmentAvailability { cars: Array<{ id: number; name: string; plate_number: string; category: string; passenger_capacity: number }>; drivers: Array<{ id: number; name: string; phone: string; rating: string; car_ids: number[] }> }
