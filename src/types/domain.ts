...
export type AttendanceStatus =
  "expected" | "partially_checked_in" | "checked_in";
...
export interface CheckInBooking {
  ...
  check_ins: Array<{
    id: number;
    passengers_checked_in: number;
    total_checked_in: number;
    checked_in_at: string;
    checked_in_by: { id: number; name: string; role: UserRole } | null;
  }>;
}
...
export interface DriverBooking extends Booking {
  id: number;
}
export interface DashboardStats {
  ...
  revenue: { total_minor: number; month_minor: number; currency: Currency };
  top_tours: Array<{ id: number; slug: string; bookings_count: number }>;
  top_cars: Array<{ id: number; name: string; bookings_count: number }>;
}
